$(document).ready(function() {
  ...
  if (window.location.href.indexOf("schedule") > -1) {
    ...
    const events = [
    {
        ...
        description: `
        ksyhbf,jablfygluihnf;uglrubirlufoyaberlkf;ahlygfu;ifpgakeruf;ijsdugfasbrfaugryflkjnfkbdfv
        `
    },
    // {
    ...
    createEl("div", {class: "card mb-5"}, 
        createEl("h5", {class: "card-header"}, "Monday"),
    ...
    createEl("div", {class: "card mb-5"}, 
        createEl("h5", {class: "card-header"}, "Tuesday"),
    ...
    createEl("div", {class: "card mb-5"}, 
        createEl("h5", {class: "card-header"}, "Wednesday"),
    ...
    const containerEl = createEl("div", {class: "container"},
      createEl("div", {class: "card mb-3"}, 
        ...
        createEl("div", {class: "card-body"}, 
          ...
          createEl("a", {class: "btn btn-primary", href: "services.html"}, "See what we offer!")
        )
      ),
  ...
  const carouselSlides = [
    ...
    {
      title: "Best Pressure Washing In Town!",
      subtitle: "What are you waiting for?",
      // img: "./assets/img/grill.jpg",
      btnText: "Purchase a Service",
      btnUrl: "services.html"
    },
  ]
